...
| [**craft**](plugins/craft/README.md) | 5 | Cross-language software craftsmanship principles (refactoring, OOP, code-style, testing, TDD workflow; DDD/security planned) — pairs with language example skills |
