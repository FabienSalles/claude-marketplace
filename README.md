...
| [**craft**](plugins/craft/README.md) | 1 | Cross-language software craftsmanship principles (refactoring; DDD/OOP/TDD/testing/style planned) — pairs with language example skills |
