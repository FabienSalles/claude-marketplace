...
```bash
# Step 1: Visit this URL in a browser; Google redirects to the loopback address with the code
echo "https://accounts.google.com/o/oauth2/v2/auth?client_id=${GOOGLE_CLIENT_ID}&redirect_uri=http://localhost:8085/&scope=https://www.googleapis.com/auth/analytics.readonly&response_type=code&access_type=offline"
