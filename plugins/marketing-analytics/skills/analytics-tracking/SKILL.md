...
Key analytics tools by use case:

| Tool | Best For |
|------|----------|
| **GA4** | Web analytics, Google ecosystem — deep dive in `references/ga4-implementation.md` |
| **GTM** | Container-based tag management — deep dive in `references/gtm-implementation.md` |
...
- **marketing-analytics:google-analytics** — pull/report GA4 data once tracking is live
- **marketing-analytics:search-console** — search-side reporting complement
- **marketing-content:seo-audit** — site-health audit that feeds tracking priorities
