---
name: ts-ddd-events
description: This skill should be used when implementing domain events, event store, outbox pattern, or reliable event publishing. Provides event-driven DDD patterns.
version: "1.0"
---
...
```typescript
// domain/events/receipt-generated.event.ts
...
**Consume events** from a worker or message broker:
