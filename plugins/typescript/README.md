...
| [`ddd-ts-fp`](skills/ddd-ts-fp/SKILL.md) | Immutable aggregates as readonly types, curried domain operations, makers with context (`make*`), validation/enrichment pipelines |
