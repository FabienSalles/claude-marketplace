...
1. **Create Failing Test Case**
   ...
   - Use the `craft:tdd-workflow-principles` skill for writing proper failing tests
...
**Related skills:**
- **craft:tdd-workflow-principles** - For creating failing test case (Phase 4, Step 1)
