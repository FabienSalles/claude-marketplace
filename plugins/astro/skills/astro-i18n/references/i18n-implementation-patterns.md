...
## Table of Contents
- [Route Mapping Implementations](#route-mapping-implementations)
- [Translation Dictionary Setup](#translation-dictionary-setup)
- [Multilingual Content Collections](#multilingual-content-collections)
- [SEO for Multilingual Sites](#seo-for-multilingual-sites)
- [Language Switcher Component](#language-switcher-component)
- [Navigation with Translations](#navigation-with-translations)

## Route Mapping Implementations
...
<a
  ...
  class="lang-switch"
  data-astro-reload
  aria-label={targetLang === 'en' ? 'Switch to English' : 'Passer en francais'}
>
