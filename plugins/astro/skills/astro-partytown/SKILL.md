...
description: This skill should be used when integrating third-party scripts like Google Analytics, Facebook Pixel, or other tracking scripts. Uses Partytown to run scripts in a web worker.
version: "1.0"
---
...
The `forward` array tells Partytown which functions to proxy from main thread to worker:
...
Check browser console for Partytown logs.
