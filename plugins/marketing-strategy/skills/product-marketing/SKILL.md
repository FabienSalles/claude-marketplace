...
**Before you start:** if `.claude/product-marketing-context.md` exists, read it first — it captures foundational positioning, ICP, and messaging inputs so you don't ask the user to repeat themselves. See the `product-marketing-context` skill to create it.
...
For deep competitive market analysis (SEO, ads, social, pricing benchmarks), use the **`competitor-analysis`** skill. This section focuses on **sales-facing** artifacts (battlecards, win/loss).
