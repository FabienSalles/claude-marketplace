...
- **marketing-content:copywriting** — write copy using these psychological principles
- **marketing-content:copy-editing** — audit existing copy for missing triggers
- **marketing-strategy:icp-builder** — the persona work that determines which biases resonate
- **marketing-strategy:product-marketing** — apply category-choice and value-attribute psychology to positioning
