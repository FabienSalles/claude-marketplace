...
For subject-line formulas, open-rate rules, spam triggers, and A/B testing methodology, see the **`email-subject-lines`** skill. This skill focuses on the newsletter as a whole (content, growth, monetization).
